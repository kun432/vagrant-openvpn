...
sudo nmcli c m "System eth0" ipv4.ignore-auto-route yes
sudo nmcli c m "System eth1" ipv4.never-default no
sudo nmcli c m "System eth1" ipv4.ignore-auto-dns yes
sudo nmcli c m "System eth1" ipv4.ignore-auto-route yes
